            ...
            <section className="about-container">
                <div className="about-body">
                    ...
                    <section className="info">
                        <p className="info-paragraph">I'm a Columbus based self-taught front end web developer who began studying in 2022. I thoroughly enjoy problem-solving and turning complex tasks into simple, elegant solutions. Before I started my journey in web development I was a barista. I like this a lot more!</p>
